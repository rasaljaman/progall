  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert text-textSecondary">
        ...
        <h3 className="text-xl text-primary font-semibold mt-6 mb-2">Data Collection</h3>
        ...
        <h3 className="text-xl text-primary font-semibold mt-6 mb-2">Third-Party Services</h3>
